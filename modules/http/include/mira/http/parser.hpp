...
// Mira/http/parser.hpp — incremental HTTP/1.1 message parsing.
//
...
/// `Mira::Errc`. They exist as named values because "400 Bad Request" is
...
namespace std {
template<>
struct is_error_code_enum<Mira::http::ParseError> : true_type {};
}  // namespace std
